  ...
  const handleTerbitkan = (e) => {
    if (props.roleUser === 2) {
      if (props.dataUser.noTelepon !== null && props.dataUser.alamat !== null && props.dataUser.img !== null) {
        ...
        var config = {
          method: "post",
          url: `http://localhost:8081/barang/${props.userId}/daftar`,
          headers: {
        ...
        <div className="formproduk_custom mx-auto">
          ...
          >
            ...
            <div className="mb-3">
              ...
              <input className="form-control form1_custom" placeholder="Kategori" type="text" id="exampleFormControlInput1" onChange={(e) => setKategori(e.target.value)} required />
            </div>
